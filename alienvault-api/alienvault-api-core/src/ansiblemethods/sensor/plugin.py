...
def ansible_get_sensor_plugins(system_ip):
    ...
    try:
        ...
        for idx, current_plugin in enumerate(plugins['enabled']['detectors']):
            if current_plugin == 'suricata':
                plugins['enabled']['detectors'][idx] = 'AlienVault_NIDS'
            elif current_plugin == 'suricata-eve':
                plugins['enabled']['detectors'][idx] = 'AlienVault_NIDS-eve'
            elif current_plugin == 'suricata-http':
                plugins['enabled']['detectors'][idx] = 'AlienVault_NIDS-http'
            elif current_plugin == 'ossec-single-line':
                plugins['enabled']['detectors'][idx] = 'AlienVault_HIDS'
            elif current_plugin == 'ossec-idm-single-line':
                plugins['enabled']['detectors'][idx] = 'AlienVault_HIDS-IDM'
            elif current_plugin == 'nagios':
                plugins['enabled']['detectors'][idx] = 'availability_monitoring'
        ...
        plugins['plugins']['AlienVault_NIDS-eve'] = plugins['plugins'].pop('suricata-eve')
        plugins['plugins']['AlienVault_NIDS-http'] = plugins['plugins'].pop('suricata-http')
