...
def get_sensor_detectors(system_ip):
    ...
    for idx, current_plugin in enumerate(parsed_return[1]['sensor_detectors']):
        if current_plugin == 'suricata':
            parsed_return[1]['sensor_detectors'][idx] = 'AlienVault_NIDS'
        elif current_plugin == 'suricata-eve':
            parsed_return[1]['sensor_detectors'][idx] = 'AlienVault_NIDS-eve'
        elif current_plugin == 'suricata-http':
            parsed_return[1]['sensor_detectors'][idx] = 'AlienVault_NIDS-http'
        elif current_plugin == 'ossec-single-line':
            parsed_return[1]['sensor_detectors'][idx] = 'AlienVault_HIDS'
        elif current_plugin == 'ossec-idm-single-line':
            parsed_return[1]['sensor_detectors'][idx] = 'AlienVault_HIDS-IDM'
        elif current_plugin == 'nagios':
            parsed_return[1]['sensor_detectors'][idx] = 'availability_monitoring'
