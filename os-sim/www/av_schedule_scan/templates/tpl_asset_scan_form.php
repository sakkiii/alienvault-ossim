...
if($params != '')
{
    $ttemplate = $nmaps_params['ttemplate'] ;
    $autodetected = $nmaps_params['aggressive_scan'] ;
    $rdns = $nmaps_params['rdns'] ;
    $scan_type = $nmaps_params['stype'] ;
    $scan_ports = $nmaps_params['custom_scan_ports'] ;

    $targets = $nmaps_params['targets'];
}
else
{
    $targets = '';
