					...
					success: function(msg) {
						...
						for (var i=0;i<jobs.length;i++) {
							var data = jobs[i].split("|");
							{
								...
								//If undefined value is returned the bar is not refresh
								if(vulns_data[1] !== undefined) {
...
if (empty($arruser)){
    ...
    #When sorting by next_CHECK the system protect the _ with \ and the mysql is not able to undertand it
