...
{ 
    ...
    if( $error_message == "" ) 
	{
        ...
        $root = $doc->createElement('create_credential');
						...
						<tr>
							...
							<td class='itd'>
								...
								<select name="vulnerability_incident_threshold">
									<?php 
									foreach ($threshold_values as $tv_label => $tv_value)
									{
										?>
										<option <?php echo $tv_value == $vit ? " selected='selected'": ""?> value="<?php echo $tv_value?>">
                                            <?php echo $tv_label?>
                                        </option>
										<?php
									}
