...
function GetOssimSignatureName($plugin_id, $plugin_sid, $db,$ctx = null) {
    ...
    return isset($_SESSION['_sig_names'][$plugin_id." ".$plugin_sid . " " . $ctx])? $_SESSION['_sig_names'][$plugin_id." ".$plugin_sid . " " . $ctx]:$_SESSION['_sig_names'][$plugin_id." ".$plugin_sid . " " . $default_context];
}
