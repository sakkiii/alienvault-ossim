...
<head>
	...
	<script type="text/javascript">
		...
		function add_rep_filter() {
			...
			var dir_txt = (dir_id == 1) ? '<?php echo _("Src")?>.' : '<?php echo _("Dest")?>.';

			var rep_sev_lem = $('#rep_sev_lem').val();
            var rep_rel_lem = $('#rep_rel_lem').val();
			var sev_counter = more_less_switcher(sev_id,rep_sev_lem);
			var rel_counter = more_less_switcher(rel_id,rep_rel_lem);
								...
								<tr>
									<td class="left nobborder">
										<div style='text-align: left; padding:0 0 15px 10px; clear: both;'>
											...
											<div style='float: left;'>
												<input type="radio" name="rep_dir" value="1" checked="checked"/> <?php echo _("Source")?>
