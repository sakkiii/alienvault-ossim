    ...
    'IncidentGeneration' => array(
        ...
        'conf' => array(
            ...
            'tickets_max_days' => array(
                'type' => 'text',
                'help' => '' ,
                'desc' => _('Days to delay ticket notifications'),
                'advanced' => 0 ,
                'section' => 'tickets'
            ),
...
function custom_actions($api_client, $ossim_conf, $actions)
{
    ...
    if (array_key_exists('track_usage_information', $actions)){
        $track_usage_information = ($actions['track_usage_information'] > 0) ? TRUE : FALSE;
        $api_client->system()->set_telemetry($track_usage_information);
    }
...
if (POST('update'))
{
    ...
    for ($i = 0; $i < POST('nconfs'); $i++)
    {
        ...
        {
            $_POST["value_$i"] = "/usr/sbin/greenbone-nvt-sync";
        }
